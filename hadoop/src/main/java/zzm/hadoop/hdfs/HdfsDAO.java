...
public class HdfsDAO {
    //修改成自己的HDFS主机地址
    private static final String HDFS = "hdfs://192.168.1.245:8082/";
    /**
     * 两个构造器
     * @param conf
     */
    ...
    public static void main(String[] args) throws IOException {
         ...
         * 测试拷贝文件
         */
     // hdfs.copyFile("D:\\workspace\\hadoop\\src\\main\\java\\zzm\\hadoop\\App.java", "/user/hadoop");
        /**
         * 测试遍历文件目录
         */
        hdfs.ls("/user");
...
//      hdfs.rename("/out.txt", "/out");
       ...
       // hdfs.location();
        ...
        hdfs.createFile("/user/zzm.txt", "hadoop java zzm");
        
        //hdfs.cat("/user/file1.txt");
    }
